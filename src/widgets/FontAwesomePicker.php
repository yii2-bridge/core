...
class FontAwesomePicker extends Select2
{
    public $data = [
        'fa-glass' => '\f000',
        'fa-music' => '\f001',
    ...
    {
        $formatFunc = new JsExpression(<<<JS
function (icon) {
    var originalOption = icon.element;
    
    return $('<span><i class="fa ' + $(originalOption).val() + '"></i> ' + icon.text + '</span>');
}
JS
        );

        $this->pluginOptions = [
            'templateSelection' => $formatFunc,
            'templateResult' => $formatFunc,
    ...
    protected function renderInput()
    {
        ...
        $options = [];
        foreach ($this->data as $icon => $unicode) {

            $options[] = Html::tag('option', $this->getIconLabel($icon), [
                'value' => $icon,
                'data-icon' => $icon
            ]);
        }
    ...
    protected function getIconLabel($icon)
    {
        return ucfirst(str_ireplace(['fa-', '-'], ['', ' '], $icon));
    }
}